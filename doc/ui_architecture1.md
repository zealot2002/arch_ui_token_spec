...
> - [第二篇：Drawable 层的规范设计](/ui_architecture3)
> - [第三篇：Style 层的工程化实践](/ui_architecture4)
> - [第四篇：架构总结与设计主权回归](/ui_architecture5)
...
在多年的跨平台 App 开发实践中，我发现颜色管理是困扰许多团队的共性问题：
- 同一个色值在项目中被重复定义几十次
- 修改品牌色需要全局搜索替换上百个地方
- 夜间模式适配工作量巨大
...
1. **结构优化**：
   - 重新组织了文章结构，按照"问题提出→方案分析→代码实现→效果验证→总结反思"的逻辑展开
   - 增加了问题根本原因分析，使论证更完整
...
5. **细节完善**：
   - 添加了适用场景和不适用场景的说明，明确架构的局限性
   - 增加了扩展方向的讨论，为读者提供后续探索的思路
